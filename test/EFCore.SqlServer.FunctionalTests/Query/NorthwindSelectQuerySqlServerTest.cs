...
OFFSET @__p_0 ROWS");
        ...
        public override async Task Projection_Distinct_projection_contains_intermittent_column(bool async)
        {
            await base.Projection_Distinct_projection_contains_intermittent_column(async);
